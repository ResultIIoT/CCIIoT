            ...
            while (tmp3 != null) {
                ...
                while (tmp3 != null) {
                    if (tmp3.contains(ft1) || tmp3.contains(ft2)) {
                        ...
                        if (tmp4.contains(Utilities.Object + "s")) {
                            break;
                        }
                        tmp3 = tmp4;
                    } else
                ...
                // tmp3和tmp4存储新的克隆对信息串；
                filepath3 = tmp3.substring(tmp3.indexOf(Utilities.Object + "s"), tmp3.indexOf(Utilities.postfix) + Utilities.postfix.length());//取版本2中克隆2.1文件路径；
                filepath4 = tmp4.substring(tmp4.indexOf(Utilities.Object + "s"), tmp4.indexOf(Utilities.postfix) + Utilities.postfix.length());//取版本2中克隆2.2文件路径；
                //保存所取克隆对的文件信息；
                            ...
                            while (tmp3 != null) {
                                if (tmp3.contains(ft1) || tmp3.contains(ft2)) {
                                    ...
                                    if (tmp4.contains(Utilities.Object + "s")) {
                                        ...
                                        String tmpfilepath3 = tmp3.substring(tmp3.indexOf(Utilities.Object + "s"), tmp3.indexOf(Utilities.postfix) + Utilities.postfix.length());//取版本2中克隆1文件路径；
                                        String tmpfilepath4 = tmp4.substring(tmp4.indexOf(Utilities.Object + "s"), tmp4.indexOf(Utilities.postfix) + Utilities.postfix.length());//取版本2中克隆2文件路径；
